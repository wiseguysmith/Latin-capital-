...
|---|---|---|---|---|---|---|
| OQ-01 | Which commercial model for pilot (application fee, assessment fee, subscription, provider access fee)? Success/percentage fees raise broker-characterization and conflict concerns (CRF §19) | Revenue model; regulatory characterization | Manual invoicing, disclosed flat fees; no success fees in pilot (ASM-10, D-15) | Blocking-launch (pricing only) | Founder | 0 |
| OQ-02 | Operating entity structure and licensing posture per country (single entity vs local subsidiaries; any registration duties, e.g. CR Law 7786 for relevant activities) | Legal perimeter | Single entity assumption (ASM-14); no regulated activity performed | Blocking-launch | Counsel | 0 |
| OQ-03 | Product brand name | Marketing, domain, terms | "Capital Readiness Platform" (ASM-01) | Non-blocking | Founder | 1 |
| OQ-04 | Cross-border transfer & data residency: may CR/PA/SV borrower and UBO data be processed in US-region cloud? Localization duties? | Architecture region choice; DPA content | Residency-configurable architecture (ASM-05) | Blocking-launch | Counsel | 0 |
