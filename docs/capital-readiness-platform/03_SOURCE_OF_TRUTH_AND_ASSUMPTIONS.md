...
| ASM-05 | Cloud deployment on a major provider with LatAm-acceptable data-residency posture; region selection pending counsel (data-localization) | Conservative: architecture keeps residency configurable | 40, 44, 46 | Counsel (OQ-06) |
